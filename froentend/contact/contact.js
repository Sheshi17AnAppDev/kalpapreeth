...
contactForm.addEventListener('submit', async function(e) {
    ...
    try {
        ...
        showNotification('Thank you for your inquiry. We have received your message and will respond within 24 hours.', 'success');
...
document.querySelectorAll('.info-item, .faq-item, .hero-stats').forEach(el => {
    observer.observe(el);
});
